...
const GitHubRepositorySlugSchema = z.string().regex(
...
function formatRelayContractComment(marker: string, value: unknown): string {
...
export function formatIssueRelayDecisionRequestComment(
  ...
  return formatRelayContractComment(
...
export function formatIssueRelayHumanDecisionReceiptComment(
  ...
  return formatRelayContractComment(
    '<!-- jinn-issue-relay:human-decision:v1 -->',
